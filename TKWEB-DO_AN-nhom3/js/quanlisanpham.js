...
var manufactureList = {
    ...
    "XE ĐƯỜNG TRUÒNG": [
        ...
        "Madone SLR 7 [Gen 7]",
        "Domane AL 3 Disc 2023"
    ],
    "XE THÀNH PHỐ": [
        "Verve 1 Disc [2023]",
        "Dual Sport 3 [2023] Gen 5",
        "FX 2 Disc Stagger"    
    ],    
}
...
function addProduct() {
    ...
    document.getElementById('result').innerHTML += `<tr>
                ...
                <td><button class="btn btn-danger" onclick="deleteProduct(${count - 1})">Xoá</button></td>
            </tr>`
}

function deleteProduct(index) { if (confirm("Bạn đồng ý xóa?") == false) {
...
function showProduct() {
    ...
    for (var i = 0; i < productList.length; i++) {
        document.getElementById('result').innerHTML += `<tr>
                ...
                <td><button class="btn btn-danger" onclick="deleteProduct(${i})">Xoá</button></td>
            </tr>`
    }
}
